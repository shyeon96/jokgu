        ...
        >
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 w-full max-w-sm bg-white p-8 rounded-2xl shadow-md">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <input id="username" type="text" {...register('username', { required: true })} placeholder="아이디를 입력하세요"
                        className="border border-gray-200 rounded-lg px-4 py-2.5 text-sm outline-none focus:border-[#22c55e] transition" autoComplete="username" />
                </div>

                <div className="flex flex-col gap-1">
                    <label htmlFor="password" className="text-sm font-medium text-gray-600">비밀번호</label>
                    <input id="password" type="password" {...register('password', { required: true })} placeholder="비밀번호를 입력하세요"
                        className="border border-gray-200 rounded-lg px-4 py-2.5 text-sm outline-none focus:border-[#22c55e] transition" autoComplete="current-password" />
                </div>
